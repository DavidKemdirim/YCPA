...
% Boundary Conditions
bc{1}.NumS = 1;
bc{1}.s(1).xpos = nx{1}/(4) + 1; % where wave starts propogating from
bc{1}.s(1).type = 'ss';
...
betap = 0;
t0 = 30e-15;
st = -0.05; % controls how long until wave disperses
% st = 15e-15;
s = 0;
y0 = yMax/2;
sty = 1.5*lambda;
...
% determines strength of wave after propogating, and how long it 
% propogates in any direction
bc{1}.xm.type = 'a';
bc{1}.xp.type = 'a';
bc{1}.ym.type = 'a';
bc{1}.yp.type = 'a';
